...
public class ShopBoughtFragment extends BaseFragment implements ShopListContract.View {
    ...
    public void setListShopToAdapter(List<ShopModel> listShop) {
        ...
        for(int i=0; i<listShop.size(); i++){
            if(listShop.get(i).getState().equals(StateEnum.BOUGHT.toString())){
                shopNotBought.add(listShop.get(i));
            }
        }
        listAdapter.setList(shopNotBought, StateEnum.BOUGHT.toString());
        hideProgressDialog();
    }
